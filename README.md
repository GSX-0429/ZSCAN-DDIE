...
```python
python main.py --config configs/configs.py
```
...
```python
python main.py --config configs/configs.py --zsl_para work_dirs/zeroddi/model_parameter/zsl_model_best_epoch50_seed42.pkl --gzsl_para work_dirs/zeroddi/model_parameter/gzsl_model_best_epoch50_seed42.pkl
```